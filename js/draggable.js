...
( function( window, factory ) {
  ...
  const denseItems = document.querySelectorAll(".dense_item");
...
denseItems.forEach(
  (cell) =>
    (cell.style.transform =
      "translate(" + getRandom(-50, 50) + "px, " + getRandom(-50, 50) + "px)")
);

//draggables
// if you have multiple .draggable elements
// get all draggie elements
var draggableElems = document.querySelectorAll(".dense_item");
